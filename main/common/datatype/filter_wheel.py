...
class FilterWheel():
    ...
    def deserialized(text):
        return json.loads(text, object_hook=_dict_to_filter_object) #there was a typo in the spelling of 'object'

def _dict_to_filter_object(dict):
    return FilterWheel(dict['position_1'], dict['position_2'], dict['position_3'], dict['position_4'], #typos in 'position' fro 4 and 8
